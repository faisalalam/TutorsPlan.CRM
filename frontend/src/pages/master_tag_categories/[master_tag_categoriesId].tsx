...
const EditMaster_tag_categories = () => {
  ...
  const { master_tag_categoriesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: master_tag_categoriesId }));
  }, [master_tag_categoriesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: master_tag_categoriesId, data }));
...
EditMaster_tag_categories.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditMaster_tag_categories;
