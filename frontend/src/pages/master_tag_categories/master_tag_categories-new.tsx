...
import { create } from '../../stores/master_tag_categories/master_tag_categoriesSlice';
...
const Master_tag_categoriesNew = () => {
...
Master_tag_categoriesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_MASTER_TAG_CATEGORIES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Master_tag_categoriesNew;
