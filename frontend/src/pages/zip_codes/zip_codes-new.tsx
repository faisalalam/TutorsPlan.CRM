...
import { create } from '../../stores/zip_codes/zip_codesSlice';
...
Zip_codesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_ZIP_CODES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Zip_codesNew;
