...
const EditExam_difficulty_level_typesPage = () => {
...
EditExam_difficulty_level_typesPage.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditExam_difficulty_level_typesPage;
