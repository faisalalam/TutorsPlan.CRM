...
const EditContact_types = () => {
  ...
  const { contact_typesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: contact_typesId }));
  }, [contact_typesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: contact_typesId, data }));
...
EditContact_types.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditContact_types;
