...
const EditCourse_level_types = () => {
  ...
  const { course_level_typesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: course_level_typesId }));
  }, [course_level_typesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: course_level_typesId, data }));
...
EditCourse_level_types.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditCourse_level_types;
