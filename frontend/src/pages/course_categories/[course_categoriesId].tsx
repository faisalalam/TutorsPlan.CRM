...
const EditCourse_categories = () => {
  ...
  const { course_categoriesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: course_categoriesId }));
  }, [course_categoriesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: course_categoriesId, data }));
...
export default EditCourse_categories;
