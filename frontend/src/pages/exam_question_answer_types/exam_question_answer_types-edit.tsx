...
const EditExam_question_answer_typesPage = () => {
...
EditExam_question_answer_typesPage.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditExam_question_answer_typesPage;
