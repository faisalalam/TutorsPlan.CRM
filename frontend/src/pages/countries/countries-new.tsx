...
import { create } from '../../stores/countries/countriesSlice';
...
CountriesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_COUNTRIES'}>
      {page}
    </LayoutAuthenticated>
  );
};
