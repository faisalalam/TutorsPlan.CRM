...
const EditScholarship_application_statuses = () => {
  ...
  const { scholarship_application_statusesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: scholarship_application_statusesId }));
  }, [scholarship_application_statusesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: scholarship_application_statusesId, data }));
    await router.push(
...
EditScholarship_application_statuses.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditScholarship_application_statuses;
