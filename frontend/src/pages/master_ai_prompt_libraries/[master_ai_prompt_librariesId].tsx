...
const EditMaster_ai_prompt_libraries = () => {
  ...
  const { master_ai_prompt_librariesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: master_ai_prompt_librariesId }));
  }, [master_ai_prompt_librariesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: master_ai_prompt_librariesId, data }));
    await router.push(
...
EditMaster_ai_prompt_libraries.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditMaster_ai_prompt_libraries;
