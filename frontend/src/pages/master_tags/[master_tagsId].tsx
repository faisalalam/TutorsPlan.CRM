...
const EditMaster_tags = () => {
  ...
  const { master_tagsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: master_tagsId }));
  }, [master_tagsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: master_tagsId, data }));
...
EditMaster_tags.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditMaster_tags;
