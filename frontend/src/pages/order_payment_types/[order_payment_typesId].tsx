...
const EditOrder_payment_types = () => {
  ...
  const { order_payment_typesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: order_payment_typesId }));
  }, [order_payment_typesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: order_payment_typesId, data }));
...
EditOrder_payment_types.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditOrder_payment_types;
