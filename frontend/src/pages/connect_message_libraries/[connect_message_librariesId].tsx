...
const EditConnect_message_libraries = () => {
  ...
  const { connect_message_librariesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: connect_message_librariesId }));
  }, [connect_message_librariesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: connect_message_librariesId, data }));
    await router.push(
...
EditConnect_message_libraries.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditConnect_message_libraries;
