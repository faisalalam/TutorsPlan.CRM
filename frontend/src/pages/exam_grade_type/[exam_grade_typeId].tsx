...
const EditExam_grade_type = () => {
  ...
  const { exam_grade_typeId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: exam_grade_typeId }));
  }, [exam_grade_typeId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: exam_grade_typeId, data }));
...
EditExam_grade_type.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditExam_grade_type;
