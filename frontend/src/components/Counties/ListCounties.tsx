...
const ListCounties = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_COUNTIES');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/counties/counties-edit/?id=${item.id}`}
                  pathView={`/counties/counties-view/?id=${item.id}`}
