...
export const loadColumns = async (
  ...
  return [
    ...
    {
      field: 'published_on_public_site',
      headerName: 'PublishedonPublicSite',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
    ...
    {
      field: 'bootcamp_course',
      headerName: 'BootcampCourse',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
    ...
    {
      field: 'regular_course',
      headerName: 'RegularCourse',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
