...
const TableSampleCourse_categories = ({
  filterItems,
  setFilterItems,
  filters,
  showGrid,
  ...
  const {
    ...
    loading,
    count,
    notify: course_categoriesNotify,
    refetch,
  } = useAppSelector((state) => state.course_categories);
  ...
  useEffect(() => {
    if (course_categoriesNotify.showNotification) {
      notify(
        course_categoriesNotify.typeNotification,
        course_categoriesNotify.textNotification,
      );
    }
  ...
  const handleEditAction = (id: string) => {
    router.push(`/course_categories/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/course_categories/course_categories-view/?id=${id}`);
  };
