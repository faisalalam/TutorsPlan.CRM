...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/states/statesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureStatesCols';
...
const TableSampleStates = ({
  ...
  useEffect(() => {
    if (statesNotify.showNotification) {
      notify(statesNotify.typeNotification, statesNotify.textNotification);
    }
  }, [statesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/states/states-view/?id=${id}`);
  };
...
export default TableSampleStates;
