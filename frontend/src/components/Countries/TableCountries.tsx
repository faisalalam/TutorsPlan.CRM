...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/countries/countriesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCountriesCols';
...
const TableSampleCountries = ({
  ...
  useEffect(() => {
    if (countriesNotify.showNotification) {
      notify(
        countriesNotify.typeNotification,
        countriesNotify.textNotification,
      );
    }
  }, [countriesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/countries/countries-view/?id=${id}`);
  };
...
export default TableSampleCountries;
