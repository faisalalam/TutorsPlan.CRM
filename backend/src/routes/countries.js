...
router.get(
  ...
  wrapAsync(async (req, res) => {
    ...
    const payload = await CountriesDBApi.findAll(req.query);
    if (filetype && filetype === 'csv') {
      const fields = ['id', 'name', 'ticker', 'flag_icon', 'phone_code'];
      const opts = { fields };
      try {
...
router.get(
  '/:id',
  wrapAsync(async (req, res) => {
    const payload = await CountriesDBApi.findBy({ id: req.params.id });
